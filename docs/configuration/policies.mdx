...
<Note>
  ...
  [Rollout playbook](/deployment/rollout-playbook) sequences this.
</Note>
...
2. Watch the **Bundle** column on [Devices](/deployment/devices) converge.
3. Confirm in [Telemetry](/configuration/telemetry) that the rule is matching
