...
Your organization sets a **default mode** for the fleet — shown in the console as
...
<Warning>
  ...
  is ever blocked. A rule your administrator promoted still blocks. The console
  shows which rules are currently enforcing.
</Warning>

## Where to see the active mode

The console is the authoritative view: the Rules page shows the fleet default
...
See [Rules and policy](/configuration/policies) for how a rule is authored and
...
AgenShield the blocked-activity record from the console.
