...
protected on this Mac. See [How AgenShield works](/how-it-works).
...
See [Network inspection certificate](/reference/mitm-ca-for-end-users) for what
...
[Collecting diagnostics](/troubleshoot/collecting-diagnostics), which lists what
the bundle contains and what it never contains.

## Related

- [How AgenShield works](/how-it-works) — what "protected" means and what
  AgenShield never touches.
- [Enforcement modes](/configuration/enforcement-modes) — whether activity is
