...
[what happens on the device](/deployment/mdm/overview#what-happens-on-the-device).
...
Everything else is on the [MDM enrollment reference](/deployment/mdm/overview#troubleshooting).
