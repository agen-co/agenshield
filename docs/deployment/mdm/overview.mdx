...
[install campaign](/deployment/campaigns) — nothing to edit, script, or sign.
...
<Steps>
  ...
  <Step title="Push both to the same device group">
    ...
    [Microsoft Intune](/deployment/mdm/intune), [Jamf](/deployment/mdm/jamf),
    or [Kandji, JumpCloud, Mosyle, and others](/deployment/mdm/other).
  </Step>
...
| An [install campaign](/deployment/campaigns) | Both artifacts are generated from it             |
...
<Columns cols={2}>
  <Card title="Microsoft Intune" icon="plug" href="/deployment/mdm/intune">
    The connected integration — push campaigns straight from the console.
  </Card>
  <Card title="Jamf" icon="server" href="/deployment/mdm/jamf">
    Jamf Pro and Jamf Now.
  </Card>
  <Card title="Other MDMs" icon="boxes" href="/deployment/mdm/other">
