...
Get both artifacts from your [install campaign](/deployment/campaigns) first.
...
<Note>
  ...
  [Quickstart](/getting-started/quickstart) for what that looks like.
</Note>
...
[MDM troubleshooting table](/deployment/mdm/overview#troubleshooting).
