...
| 2   | [Enrol devices](./deployment/mdm/overview.mdx)                    | Macs reporting in, with no prompts on a managed fleet        |
...
| A developer using a protected agent | [Working with a protected agent](./using/protected-agents.mdx)                                                |
