...
icon: wrench
description: Diagnose the problems that actually happen — the service not running, a degraded system report, blocked work, stale policy, and what to do about each.
---

<img
  src="../images/page-heroes/troubleshoot-common-issues.png"
  alt="Common Issues cover — triage without panic."
  noZoom
/>
