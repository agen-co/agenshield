...
[Overview page in the app](/using/the-app) names what needs attention, and two
...
<AccordionGroup>
  ...
  <Accordion title="No agent has been protected yet">
    ...
    See [How AgenShield works](/how-it-works) for what protecting an agent does.
  </Accordion>
  ...
  <Accordion title="The macOS approvals were never granted">
    ...
    filtering. [What gets installed](/components) walks through each one.
...
[Enforcement modes](/configuration/enforcement-modes).
...
[Network inspection certificate](/reference/mitm-ca-for-end-users).
...
agent reported. See
[Working with a protected agent](/using/protected-agents).
...
See [Enforcement paused](/troubleshoot/extension-self-disabled) for how to
...
Then [collect a diagnostics bundle](/troubleshoot/collecting-diagnostics)
...
[Network Feels Slower](/troubleshoot/network-performance).
...
[Collect a diagnostics bundle](/troubleshoot/collecting-diagnostics) and send it
