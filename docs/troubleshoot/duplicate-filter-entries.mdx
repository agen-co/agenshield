...
- An entry that cannot be removed is usually owned by a company profile. Ask
  your IT admin to review the AgenShield profile in your device-management
  console — removing and re-pushing it replaces its entry cleanly. AgenShield
...
- If the duplicate reappears after an update, collect diagnostics
  (see [Collecting diagnostics](/troubleshoot/collecting-diagnostics)) and
