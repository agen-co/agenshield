...
icon: 'calendar-x'
description: 'An AI agent fails to connect to inspected sites with a certificate-expired error (for example CERT_HAS_EXPIRED), even though the sites themselves are fine. This is a fixed defect in how the per-site certificate was renewed.'
---

<img
  src="../images/page-heroes/troubleshoot-certificate-expired-connections.png"
  alt="Certificate Expired Errors cover — rotation, resolved."
  noZoom
/>
