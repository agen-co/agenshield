...
When [Common issues](/troubleshoot/common-issues) has not resolved a problem,
...
- [Common issues](/troubleshoot/common-issues) — try these first.
- [What gets installed](/components) — components, approvals, and health checks.
- [Privacy and data handling](/configuration/privacy-and-data) — what is observed
