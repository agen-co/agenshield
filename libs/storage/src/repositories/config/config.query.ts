...
export const Q = {
  ...
  upsert: `
    INSERT INTO ${TABLE} (profile_id, version, daemon_port, daemon_host,
      ...
      skills_json, soul_json, broker_json, enforcer_interval_ms, proxy_tls_reject_unauthorized, updated_at)
    VALUES (@profileId, @version, @daemonPort, @daemonHost,
      ...
      @skillsJson, @soulJson, @brokerJson, @enforcerIntervalMs, @proxyTlsRejectUnauthorized, @updatedAt)
    ON CONFLICT(profile_id) DO UPDATE SET
      ...
      proxy_tls_reject_unauthorized = COALESCE(@proxyTlsRejectUnauthorized, proxy_tls_reject_unauthorized),
