/**
 * Migration 021 — Add 'router' to policies.target CHECK constraint
 *
...
export class PolicyTargetRouterMigration implements Migration {
  readonly version = 21;
  readonly name = '021-policy-target-router';
