 ...
 *
 * This is the canonical source. shield-ipc re-exports for backwards compat.
 */
...
export const OPENCLAW_PRESET: PolicyPreset = {
  ...
  policies: [
    ...
    {
      id: 'preset-openclaw-package-install',
      name: 'Package Installation',
      action: 'allow',
      target: 'command',
      operations: ['package_install'],
      patterns: ['brew:*', 'npm:*', 'npx:*', 'pip:*', 'yarn:*', 'pnpm:*'],
      enabled: true,
      priority: 5,
      preset: 'openclaw',
    },
