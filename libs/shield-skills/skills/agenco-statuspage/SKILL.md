...
| Action | Description |
|--------|-------------|
| list_pages | Retrieves status pages |
| get_page | Fetches page details |
| list_incidents | Gets active incidents |
| create_incident | Reports new incidents |
| update_incident | Modifies incident status |
