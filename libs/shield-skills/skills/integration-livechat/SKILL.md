...
```bash
agentlink search-tools '{"queries":["livechat list chats"]}'
```
...
agentlink call-tool '{"toolName":"livechat_list_chats","input":{...}}'
```

> If LiveChat is not connected, run `agentlink list-connected-integrations` to check, then connect it via the Shield UI.
