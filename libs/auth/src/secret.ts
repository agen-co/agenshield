 ...
 * The secret is stored at ~/.agenshield/.jwt-secret with mode 0o600.
 */
...
/** Default secret file location — under ~/.agenshield/ */
function getDefaultSecretDir(): string {
