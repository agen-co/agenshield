...
import type { PrivilegeExecutor } from './privilege-executor.js';
...
export interface WizardContext {
  ...
  /**
   * Privilege executor for running commands as root.
   * When set (daemon/osascript mode), the engine uses this to obtain temporary
   * passwordless sudo before running setup steps. When unset (CLI/terminal mode),
   * falls back to direct sudo with keepalive.
   */
