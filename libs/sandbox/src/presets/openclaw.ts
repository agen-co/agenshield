...
import { nvmCommand } from './install-helpers.js';
...
export const openclawPreset: TargetPreset = {
  ...
  async install(ctx: InstallContext): Promise<InstallResult> {
    const { runPipeline } = await import('./actions/runner.js');
    const { getOpenclawPipeline } = await import('./actions/openclaw/pipeline.js');
