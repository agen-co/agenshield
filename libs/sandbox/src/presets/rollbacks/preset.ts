...
registerRollback('onboard_openclaw', async (ctx) => {
  // Onboarding creates .openclaw/ under agent home — handled by home directory cleanup
  ctx.onLog('Rollback: onboard_openclaw — covered by home directory cleanup');
});
