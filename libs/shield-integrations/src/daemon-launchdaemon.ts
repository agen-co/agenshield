...
export USER="$(stat -f '%Su' /dev/console 2>/dev/null || echo root)"
export AGENSHIELD_USER_HOME="${userHome}"
export AGENSHIELD_PORT="${port}"
export AGENSHIELD_HOST="${host}"
export PATH="${userHome}/.local/bin:${userHome}/.agenshield/bin:${userHome}/.agenshield/libexec:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
