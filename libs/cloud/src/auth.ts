 ...
 *
 * Ed25519 agent key management and AgentSig header creation/verification.
 */

import { generateKeyPairSync, sign, verify } from 'node:crypto';
import type { Ed25519Keypair, AgentSigParts } from './types';

/** Maximum allowed clock skew for AgentSig timestamps (5 minutes). */
export const AGENT_SIG_MAX_SKEW_MS = 5 * 60 * 1000;
