...
export const OPENCLAW_SHIELD_STEPS: ShieldStepDefinition[] = [
  ...
  { id: 'install_wrappers', phase: 4, name: 'Install wrappers', description: 'Install command wrappers for required binaries' },
  // Phase 5: PATH Router
  ...
  // Phase 7: NVM & Node.js
  { id: 'install_nvm', phase: 7, name: 'Install NVM & Node.js', description: 'Install NVM and Node.js v24 in agent home' },
